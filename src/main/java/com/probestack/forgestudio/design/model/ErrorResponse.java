 ...
 * ErrorResponse
 */
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-08-14T07:15:01.769029535Z[GMT]")public class ErrorResponse {
  ...
  */
   ...
   * @return errorCode
  */
    @Schema(name = "errorCode", example = "UNSUPPORTED_COUNTRY", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
   ...
   * @return message
  */
  @NotNull   @Schema(name = "message", example = "Validation is not available for the requested country", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
   ...
   * @return path
  */
    @Schema(name = "path", example = "/address/v1/validate", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("path")
